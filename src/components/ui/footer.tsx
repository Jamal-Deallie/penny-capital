...
const Footer = () => {
  return (
    <footer className='bg-secondary text-secondary-foreground border-accent border-t-[1.25px]'>
      <div className='mx-auto max-w-5xl px-4 py-16 sm:px-6 lg:px-8'>
        <div className='flex items-end gap-1 justify-center'>
          <Icons.logo className='h-9 fill-accent' />
          ...
          {siteConfig.primaryLinks.map((item, index) => {
            return (
              <li key={index}>
                <NavLink
                  href={item.href}
                  className='block text-lg text-center capitalize font-body leading-none'
